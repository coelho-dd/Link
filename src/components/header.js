...
export default function Header() {
    return (
        <header className="flex justify-between items-center mx-auto my-10 font-sans text-linkWhite">
            ...
            <nav>
                <ul className="flex justify-evenly space-x-2 text-lg">
                    ...
                    <li><a href="#" className="p-2 px-4 transition duration-200 ease-in hover:bg-offWhite hover:font-medium hover:text-linkBlack rounded-xl">Trabalho</a></li>
