...
export default function Services() {
    return (
        <>
            <section className="w-4/5 mx-auto text-linkWhite">
                <h1 className="text-6xl font-semibold mb-20">Serviços oferecidos</h1>
                <div className="flex">
                    <Card icon={<FcMultipleDevices />} value={"Desenvolvimento de Sites e Aplicativos Web"} text={"Front-end completo: Desenvolvimento de interfaces modernas e responsivas com React e Tailwind. Back-end com APIs: Construção de APIs e integrações usando Next.js e PostgreSQL, permitindo que suas aplicações sejam dinâmicas e interajam com bancos de dados."} />
